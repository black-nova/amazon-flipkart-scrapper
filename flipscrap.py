...
for pages in page_list: #to change pages for taking out comments and ratings for different pages
    ...
    url='https://www.flipkart.com/mivi-zero-portable-bluetooth-speaker/product-reviews/itm91dbdd04d0eb6?pid=ACCFNHGXQYSJGFKB&lid=LSTACCFNHGXQYSJGFKBJZZEQI&marketplace=FLIPKART&page=2' + str(pages)
    ...
    #below loop is used to access all the conten of comments of the pages mentioned above using its div html tag and css class
    
    for total in soup.find_all('div',class_='_3gijNv col-12-12'):
        #below loop is used to get all the content about ratings using html div tag and css class
        for rate in soup.find_all('div',class_='hGSR34 E_uFuv'):
